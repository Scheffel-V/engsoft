...
public class AddUserBookUI {
	...
	public AddUserBookUI(Controller controller, int option) {
		this.option = option;
	...
	public void addOwnBook(Controller controller) {
		if(checkFields()) {
			if(this.option == 1) {
				if(controller.createOwnBook(titleField.getText(), authorField.getText(), genreField.getText(), editionField.getText(), languageField.getText(), isbnField.getText(), photoField.getText(), commentField.getText())) {
				...
				if(controller.createWantBook(titleField.getText(), authorField.getText(), genreField.getText(), editionField.getText(), languageField.getText(), isbnField.getText(), photoField.getText(), commentField.getText())) {
					JOptionPane.showMessageDialog(null, "Livro adicionado com sucesso!");
					cleanFields();
				}else{
					JOptionPane.showMessageDialog(null, "Falha ao adicionar livro.");
